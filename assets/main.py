...
# ─────────────────────────────────────────
with st.sidebar:
    st.markdown("<div style='padding: 0 0 0.5rem 0;'>"
                "<span style='font-size:1.3rem; font-weight:700;'>🚗 매물 필터</span>"
...
#             text-align: center;'>
#          <li class='main-title' style='float: left; width: 50%; height: 80px;'>
#             <a href='#' style='text-decoration-line: none; line-height:79px;'>🚗 중고차 시세 조회</a>
#            <div class='main-subtitle'>원하는 조건을 선택하고 매물을 찾아보세요</div></li>
#          <li class='main-title'><a href='#' class='' style='text-decoration-line: none; line-height:79px;'>내 차 시세</a>
#            <div class='main-subtitle'>내 차 시세를 비교 견적해 보세요</div></li>
#     </ul>
# </div>
# """, unsafe_allow_html=True)
