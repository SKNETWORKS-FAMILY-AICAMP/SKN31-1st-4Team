...
st.set_page_config(page_title="니차내차", page_icon="🚗", layout="wide")
load_css("assets/app.css")

st.image("assets/images/main_top_banner.png", use_container_width=True)
st.markdown("<div class='main-title'>🚗 중고차 시세 조회 서비스</div>", unsafe_allow_html=True)
st.markdown("<div class='main-subtitle'>원하는 메뉴를 선택하세요</div>", unsafe_allow_html=True)

st.markdown("""
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 16px; margin-top: 1.5rem;">

  <a href="/Market_Price" style="text-decoration: none;">
    <div class="menu-card">
  ...
  <a href="/My_Car" style="text-decoration: none;">
    <div class="menu-card">
